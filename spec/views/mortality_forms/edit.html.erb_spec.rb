...
RSpec.describe "mortality_forms/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit mortality_form form" do
    render

    assert_select "form[action=?][method=?]", mortality_form_path(@mortality_form), "post" do
